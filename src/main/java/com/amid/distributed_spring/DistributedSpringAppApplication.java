...
public class DistributedSpringAppApplication implements ApplicationRunner {
    ...
    public void run(ApplicationArguments applicationArguments) throws Exception {
        ...
        // the reply, possibly null if the message could not be received to destination
        Message receivedMessage = new MessagingTemplate().sendAndReceive(inboundChannel, message);
        log.info("MessageTemplate " + receivedMessage.getPayload());
    }
}
